...
<form method="post" name="Contacto" form action="confirmacionrog.php">
<body>
...
<td class="fieldname"><table width="33%">
  ...
  <td class="fieldname">Estado: <sup>*</sup></td>
    ...
    <td height="35" colspan="2" align="center" td><input name="enviar" type="submit" id="enviar" onClick="MM_validateForm('Nombre','','R','Apellido_P','','R','Apellido_M','','R','Edad','','RinRange1:99','E-Mail','','RisEmail','Telefono','','RisNum');return document.MM_returnValue" value="Enviar>" /></td>
  </table>
</form>
</body>
</html>